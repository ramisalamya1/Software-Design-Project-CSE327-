...
import os
import sys
sys.path.insert(0, os.path.abspath('../../..'))  # Adjust to your Django project directory
os.environ['DJANGO_SETTINGS_MODULE'] = 'settings.pyt'  # Replace with your actual settings module
